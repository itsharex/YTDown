...
<template>
  <div v-if="open" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-2xl w-[560px] max-h-[80vh] overflow-auto">
      <!-- Header -->
      ...
      <!-- Footer -->
      <div class="flex justify-end gap-2 p-4 border-t border-[var(--color-separator)]">
